...
public class Listener implements TestWatcher, BeforeAllCallback, AfterEachCallback,
    ...
    private final WebDriver driver = commonActions.driver;
    ...
    public void testFailed(ExtensionContext context, Throwable cause) {
        LOGGER.info("Test {} - FAILED!", context.getTestMethod());
        String screenshotName = context.getTestMethod() +
                "_" + String.valueOf(System.currentTimeMillis()).substring(9, 13);
